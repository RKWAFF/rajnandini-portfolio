...
export default function App() {
  ...
  >
    ...
    {[ 
      "I’m an Analyst–Strategist who turns messy data into clear decisions and strategy into measurable impact. Across FMCG, SaaS, and fintech, I’ve delivered outcomes like 40% sales uplift, £50k annual cost savings, and 25% efficiency gains using SQL, Power BI, Tableau, Excel, R, and Python. I bring structured problem-solving, strong stakeholder management, and insight-led execution to build solutions that scale.",
      "I’m currently targeting Data Analyst, Business Analyst, and Strategy Consulting roles, and I’m open to working across any industry where data-driven thinking can improve performance, products, and outcomes.",
    ...
    "Work Experience": (
      ...
      >
        {[
          {
            company: "KIND Snacks UK (Mars Inc.)",
      ...
      {[
        {
          ...
          bullet:
            "Managed end-to-end publication workflow for a high-rigor statistical magazine, leading 30+ members across editorial and design teams and coordinating with faculty stakeholders to ensure quality and on-time delivery.",
        },
        {
          title: "Core Committee Member | Student Council",
          bullet:
            "Drove execution for a college festival of 10,000+ footfall by leading cross-functional coordination and managing fundraising + sponsorship negotiations, ensuring smooth stakeholder alignment and event delivery.",
        },
      ].map((item, i) => (
        <motion.div
          key={item.title}
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 text-white font-sans">
      ...
      <header className="py-6 shadow-lg bg-gray-900/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 gap-4">
         ...
         {/* Profile Picture – zooms in place */}
<div className="relative flex items-center justify-center">
  <motion.div
    onClick={() => setZoomed(!zoomed)}
    animate={{ scale: zoomed ? 2 : 1 }}
    transition={{ type: "spring", stiffness: 200, damping: 18 }}
    className="rounded-full overflow-hidden border-4 border-white shadow-xl cursor-pointer"
  >
    <img
      src={profilePic}
      alt="Rajnandini Kar"
